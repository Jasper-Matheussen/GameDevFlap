...
public class Level2 : Level
{
	...
	{
		var enemy1 = new TrolEnemy(content, new Vector2(45, 100), new Vector2(1050, 100),
			new Vector2(2.5f, 0), Color.White);
		EnemyList.Add(enemy1);
		enemy1 = new TrolEnemy(content, new Vector2(550, 350), new Vector2(1050, 350),
			new Vector2(1,0), Color.Orange);
		EnemyList.Add(enemy1);
		enemy1 = new TrolEnemy(content, new Vector2(45, 300), new Vector2(350, 300),
			new Vector2(1,0), Color.Aqua);
		EnemyList.Add(enemy1);
		enemy1 = new TrolEnemy(content, new Vector2(650, 550), new Vector2(1050, 500),
